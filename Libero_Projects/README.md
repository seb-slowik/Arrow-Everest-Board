...
This folder contains Tcl scripts that build Libero SoC v2025.2 design projects for the Arrow Everest Board. These scripts are executed in Libero SoC to generate the sample designs. All cores boot from memory at 0x8000_0000.
